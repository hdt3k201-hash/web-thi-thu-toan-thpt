...
},
{
    ...
    "correct": "B",
    "points": 1,
    "explanation": "<img src=\"https://raw.githubusercontent.com/hdt3k201-hash/web-thi-thu-toan-thpt/main/images/cau14-de4.PNG\" alt=\"Bảng biến thiên\" style=\"max-width:100%;\"><br><br>TXĐ \\( D = \\mathbb{R}^{+} \\).<br><br>Ta có \\( y' = 8x^2 + \\dfrac{2}{x} - m \\). Yêu cầu bài toán \\( \\Leftrightarrow y' \\geq 0 \\ \\forall x \\in (0;1) \\)<br><br>\\( \\Leftrightarrow 8x^2 + \\dfrac{2}{x} - m \\geq 0 \\ \\forall x \\in (0;1) \\Leftrightarrow h(x) = 8x^2 + \\dfrac{2}{x} \\geq m \\ \\forall x \\in (0;1) \\Leftrightarrow m \\leq \\min_{(0;1)} h(x) \\).<br><br>Xét hàm \\( h(x) = 8x^2 + \\dfrac{2}{x} \\ \\forall x \\in (0;1) \\). Ta có \\( h'(x) = 16x - \\dfrac{2}{x^2} \\Rightarrow h'(x) = 0 \\Rightarrow x = \\dfrac{1}{2} \\).<br><br>Lập bảng biến thiên ta được \\( h\\left(\\dfrac{1}{2}\\right) = 6 \\) là giá trị nhỏ nhất trên \\( (0;1) \\).<br><br>Từ đó suy ra \\( m \\leq 6 \\), kết hợp với \\( m \\) nguyên dương ta được \\( m \\in \\{1;2;3;4;5;6\\} \\)."
},
{
...
},
{
  ...
  },
  {
    ...
    "image_explanation": [
      "https://raw.githubusercontent.com/hdt3k201-hash/web-thi-thu-toan-thpt/main/images/cau40-de-vip4-hsa-bbt.PNG",
      "https://raw.githubusercontent.com/hdt3k201-hash/web-thi-thu-toan-thpt/main/images/cau40-de-vip4-hsa-bbt1.PNG"
    ]
  },
  {

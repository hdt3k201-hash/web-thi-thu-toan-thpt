...
# ==================== ĐỀ 7 - CÂU 1 ĐẾN CÂU 4 ====================
            ...
            # ---------------- KÉO THẢ (dragdrop) ----------------
            {
                ...
                "points": 1,
                "explanation": "Độ cao tâm vòng quay chính là vị trí cân bằng của dao động, nên $B = 60$. Bán kính vòng quay chính là biên độ, nên $|A| = 50$.\n\nTại $t = 0$, cabin ở vị trí thấp nhất nên $h(0) = 60 - 50 = 10$. Thay vào hàm số: $A\\cos(0) + 60 = 10 \\Rightarrow A = -50$ (thỏa mãn điều kiện $A < 0$).\n\nChu kì quay là $T = 15$ phút nên $\\omega = \\dfrac{2\\pi}{T} = \\dfrac{2\\pi}{15}$.\n\nVậy $h(t) = -50\\cos\\left(\\dfrac{2\\pi}{15}t\\right) + 60$.\n\nĐể tìm thời điểm cabin đạt độ cao 85m, ta giải:\n$-50\\cos\\left(\\dfrac{2\\pi}{15}t\\right) + 60 = 85 \\Leftrightarrow \\cos\\left(\\dfrac{2\\pi}{15}t\\right) = -\\dfrac{1}{2}$\n\nNghiệm dương nhỏ nhất ứng với $\\dfrac{2\\pi}{15}t = \\dfrac{2\\pi}{3} \\Leftrightarrow t = 5$ (phút).\n\nVậy: A = -50; ω = $\\dfrac{2\\pi}{15}$; B = 60; thời điểm đạt 85m là phút thứ 5."
            },

...
# ==================== ĐỀ 7 - CÂU 1 ĐẾN CÂU 4 ====================
            ...
            # ---------------- ĐÚNG / SAI (truefalse) ----------------
            {
                ...
                "points": 1,
                "explanation": "Phương trình đã cho là phương trình bậc hai theo ẩn \\( \\cos x \\). Bằng cách nhẩm nghiệm, ta phân tích được:\n\n\\( (2\\cos x - 1)(\\cos x - m) = 0 \\)\n\\( \\Leftrightarrow \\cos x = \\dfrac{1}{2} \\text{ hoặc } \\cos x = m \\)\n\na) ĐÚNG:\nPhép tách nhân tử ở trên là chính xác (chỉ khác thứ tự viết so với đề bài).\n\nb) SAI:\nKhi \\( m = 1 \\), nhánh \\( \\cos x = 1 \\) cho 2 nghiệm là \\( x = 0 \\) và \\( x = 2\\pi \\).\nNhánh \\( \\cos x = \\dfrac{1}{2} \\) luôn cho 2 nghiệm \\( x = \\dfrac{\\pi}{3} \\) và \\( x = \\dfrac{5\\pi}{3} \\).\nVậy tổng cộng có 4 nghiệm phân biệt, không phải 2.\n\nc) ĐÚNG:\nNhánh \\( \\cos x = \\dfrac{1}{2} \\) luôn cho cố định 2 nghiệm trên \\( [0; 2\\pi] \\). Để phương trình có đúng 3 nghiệm, nhánh \\( \\cos x = m \\) phải sinh thêm đúng 1 nghiệm mới (không trùng 2 nghiệm trên).\nĐiều này chỉ xảy ra khi \\( m \\) rơi vào giá trị biên \\( m = 1 \\) hoặc \\( m = -1 \\). Nhưng \\( m = 1 \\) lại cho 2 nghiệm (như câu b), nên chỉ \\( m = -1 \\) (cho nghiệm duy nhất \\( x = \\pi \\)) là thỏa mãn.\n\nd) SAI:\nVì phương trình luôn chứa nhân tử \\( \\left(\\cos x - \\dfrac{1}{2}\\right) \\), nên nó luôn có ít nhất 2 nghiệm \\( x = \\dfrac{\\pi}{3} \\) và \\( x = \\dfrac{5\\pi}{3} \\), bất kể \\( m \\) nhận giá trị nào.\nDo đó không tồn tại \\( m \\) làm phương trình vô nghiệm."
            },

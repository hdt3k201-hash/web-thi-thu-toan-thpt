...
# ==================== XỬ LÝ NỘI DUNG ĐỀ 8 ====================
    ...
    # MÀN HÌNH HIỂN THỊ ĐÁP ÁN VÀ CHẤM ĐIỂM (KHI ĐÃ NỘP BÀI)
        ...
        with st.expander("🔍 Lời giải Câu 1 - Câu 6"):
            ...
            **Câu 3 (Đáp án: 49,5):**
            Theo bài ra ta có: phương trình của Parabol là $y=60-\frac{3}{80} x^2$. Khoảng cách giữa khung Parabol và đường xuyên núi là:
            $D=60-\frac{3}{80} x^2-\left(\frac{x^3}{25600}-\frac{3 x}{16}+35\right) \text { với } x \in(-23,71 ; 27,99)$
            Xét $D^{\prime}=-\frac{3}{40} x-\frac{3 x^2}{25600}+\frac{3}{16}=0 \Leftrightarrow x=2,49$
            Bảng biến thiên:
            \begin{tabular}{|l|l|l|l|l|}
            \hline x & -23,71 & 2,49 & & 27,99 \\
            \hline D'(x) & + & 0 & - & \\
            \hline D(x) & \multicolumn{4}{|c|}{} \\
            \hline
            \end{tabular}
            Dựa vào bảng biến thiên, $M N$ là đoạn có độ dài lớn nhất khi $x=2,49$
            $\Rightarrow M N=D_{M N}=60-\frac{3}{80} \cdot 2,49^2-\left(\frac{2,49^3}{25600}-\frac{3 \cdot 2,49}{16}+35\right) \approx 25,23$
            Vì $N$ và $Q$ là hai điểm đối xứng qua $O y \Rightarrow x_{P Q} \approx-2,49$
            $\Rightarrow P Q=D_{P Q}=60-\frac{3}{80} \cdot 2,49^2-\left(\frac{-2,49^3}{25600}-\frac{3 \cdot-2,49}{16}+35\right) \approx 24,3$
            Tổng độ dài $M N+P Q=49,5$.

    ...
    # MÀN HÌNH HIỂN THỊ ĐÁP ÁN VÀ CHẤM ĐIỂM (KHI ĐÃ NỘP BÀI)
        ...
        with st.expander("🔍 Lời giải Câu 1 - Câu 6"):
            ...
            **Câu 2 (Đáp án: 2,2):** 
            ...
            $$D = 60 - \frac{3}{80}x^2 - \left(\frac{x^3}{25600} - \frac{3x}{16} + 35\right) \quad \text{với } x \in (-23{,}71; 27{,}99)$$
            Xét đạo hàm:
            $$D' = -\frac{3}{40}x - \frac{3x^2}{25600} + \frac{3}{16} = 0 \Leftrightarrow x \approx 2{,}49$$
            **Bảng biến thiên:**
            | $x$ | $-23{,}71$ | $2{,}49$ | $27{,}99$ |
            | :--- | :---: | :---: | :---: |
            | $D'(x)$ | $+$ | $0$ | $-$ |
            ...
            $$MN = D_{MN} = 60 - \frac{3}{80} \cdot (2{,}49)^2 - \left(\frac{(2{,}49)^3}{25600} - \frac{3 \cdot 2{,}49}{16} + 35\right) \approx 25{,}23$$
